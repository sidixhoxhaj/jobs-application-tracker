...
// Edit and Delete buttons for overview cards
...
const CardActions = ({ onEdit, onDelete }: CardActionsProps) => {
  return (
    <div className="card-actions">
      <button
        type="button"
        className="card-actions__button card-actions__button--edit"
        onClick={onEdit}
        title="Edit metric"
      >
      ...
      <button
        type="button"
        className="card-actions__button card-actions__button--delete"
        onClick={onDelete}
        title="Delete metric"
      >
        <svg width="14" height="14" viewBox="0 0 16 16" fill="none">
